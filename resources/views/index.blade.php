    ...
    @push('myscript')
        <script>
            ...
            */
            ...
            /*
            |--------------------------------------------------------------------------
            | Menyimpan ID Notifikasi Terbaru
            |--------------------------------------------------------------------------
            */
            ...
            */
            ...
            /*
            |--------------------------------------------------------------------------
            | Interval Suara Berulang Saat Ada Notifikasi Belum Dibaca
            |--------------------------------------------------------------------------
            */
            ...
            */
            ...
            const notificationSound = new Audio(
                "{{ asset('assets/sound/notification.mp3') }}"
            );
                ...
                try {
                    ...
                    */
                    if (firstLoad) {
                        ...
                        renderActivity(data);
                        lastNotificationId = data[0].id_notifikasi;
                        firstLoad = false;
                        return;
                    }
                    ...
                    |--------------------------------------------------------------------------
                    */
                    if (data[0].id_notifikasi != lastNotificationId) {
                        lastNotificationId = data[0].id_notifikasi;
                        renderActivity(data);

                        /*
                        |--------------------------------------------------------------------------
                        | Nyalakan Getar & Warna Merah pada Lonceng
                        |--------------------------------------------------------------------------
                        */
                        document.getElementById("btnNotifikasi").classList.add("has-new-activity");

                        /*
                        |--------------------------------------------------------------------------
                        | Putar Suara Notifikasi (Pertama Kali)
                        |--------------------------------------------------------------------------
                        */
                        ...
                        /*
                        |--------------------------------------------------------------------------
                        | Mulai Putar Ulang Suara Setiap 10 Detik
                        |--------------------------------------------------------------------------
                        */
                        ...
                        repeatSoundInterval = setInterval(function () {
                            notificationSound.currentTime = 0;
                            notificationSound.play().catch(function (error) {
                                console.log("Audio belum bisa diputar:", error);
                            });
            ...
            */
            ...
            function showActivityToast(notifikasi) {

                /*
                |--------------------------------------------------------------------------
                | Warna Toast Berdasarkan Jenis Notifikasi
                |--------------------------------------------------------------------------
                */

                let toastIcon = "info";
                switch (notifikasi.jenis_notifikasi) {
                ...
                Swal.fire({
                    ...
                    position: "top-end",
                    icon: toastIcon,
                    title: notifikasi.judul_notifikasi,
                    html: `
                                                                                                                                                <div style="text-align:left">
                                                                                                                                                    <div style="margin-bottom:5px;">
                                                                                                                                                        ${notifikasi.isi_notifikasi.replace(
                        ".",
                        ` oleh <b>${notifikasi.dibuat_oleh}</b>.`
                    )}
                                                                                                                                                    </div>
            ...
            */
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                */
                ...
                /*
                |--------------------------------------------------------------------------
                | Cek Activity Log Setiap 5 Detik
                |--------------------------------------------------------------------------
                */
                ...
                /*
                |--------------------------------------------------------------------------
                | Matikan Getar & Warna Merah Saat Lonceng Diklik
                |--------------------------------------------------------------------------
                */
                document.getElementById("btnNotifikasi").addEventListener("click", function () {
                    this.classList.remove("has-new-activity");

                    /*
                    |--------------------------------------------------------------------------
                    | Hentikan Suara Berulang
                    |--------------------------------------------------------------------------
                    */
                    if (repeatSoundInterval) {
                        clearInterval(repeatSoundInterval);
