    ...
    <div class="body" style="margin-top: 10px;">
        <div class="login-container">
            <div class="login-title">
                <h1>Aplikasi Manajemen<br>Hotel Nirwana3</h1>
            </div>
            <div class="d-flex justify-content-center align-items-center position-relative mb-3">
                ...
                {{-- Tombol Notifikasi --}}
                <div class="dropdown position-absolute" style="top:15px; right:15px; z-index:1000;">
        ...
        <script>
            ...
            */
            ...
            async function loadActivityLog() {
                try {
                    const response = await fetch("/notifikasi/json");
