    ...
    <div class="body" style="margin-top: 10px;">
        <div class="login-container">
            ...
            <div class="kotak-pesan">
                ...
                <div class="row">
                    <div class="col-12">
                        <a href="#" class="TambahModalDLX btn btn-dark w-100" style="font-size:35pt; white-space:nowrap;"
                            tipe_kamar="1">
                            Pesan Kamar
                        </a>
                    </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header bg-secondary text-white">
                            <h5 class="modal-title" id="ModalPesanKamar" style="font-size:16pt;">Tambah Pemesanan Kamar</h5>
...
@endsection
    @push('myscript')
        <script>
            ...
            $(document).on('click', '.TambahModalDLX1', function (e) {
                e.preventDefault();
