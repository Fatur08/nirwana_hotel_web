        ...
        <script>
            ...
            */
            function showActivityToast(notifikasi) {
                console.log("Toast dipanggil", notifikasi);
                /*
                |--------------------------------------------------------------------------
            ...
            */
            function showBrowserNotification(notifikasi) {
                /*
                |--------------------------------------------------------------------------
                | Pastikan browser sudah diizinkan
                |--------------------------------------------------------------------------
                */
                ...
                */
                const notification = new Notification(
                    notifikasi.judul_notifikasi,
                    {
                        body:
                            notifikasi.isi_notifikasi.replace(
                                ".",
                                ` oleh ${notifikasi.dibuat_oleh}.`
                            ),
                        icon: "{{ asset('assets/img/Nirwana_Logo.png') }}",
                        badge: "{{ asset('assets/img/Nirwana_Logo.png') }}",
                        tag: "hotel-nirwana",
                ...
                /*
                |--------------------------------------------------------------------------
                | Saat diklik kembali ke aplikasi
                |--------------------------------------------------------------------------
                */
