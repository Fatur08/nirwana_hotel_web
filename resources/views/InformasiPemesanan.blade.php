...
@section('content')
    ...
    <div class="kotak-cari">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="input-icon mb-3">
                        ...
                        <input type="text" class="form-control" name="cari_nama_tamu" placeholder="Cari Nama Tamu..."
                            value="{{ request('cari_nama_tamu') }}" style="font-size:20pt;">
                    </div>
                </div>
                <div class="col-6">
                    <select id="cari_pembayaran" name="cari_pembayaran" class="form-control mb-3" style="font-size:20pt;">
                        <option value="" {{ request('cari_pembayaran') == '' ? 'selected' : '' }}>
                            -- Pilih Pembayaran --
                        </option>
                        <option value="0" {{ request('cari_pembayaran') == '0' ? 'selected' : '' }}>
                            Belum Bayar
                        </option>
                        <option value="1" {{ request('cari_pembayaran') == '1' ? 'selected' : '' }}>
                            DP
                        </option>
                        <option value="2" {{ request('cari_pembayaran') == '2' ? 'selected' : '' }}>
                            Sudah Bayar
                        </option>
                        <option value="2_tiket" {{ request('cari_pembayaran') == '2_tiket' ? 'selected' : '' }}>
                            Sudah Bayar ( Tiket.com )
                        </option>
                    </select>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-6">
                <a href="#" class="BuatResiManual btn btn-info w-100" style="font-size:20pt;">
                    Buat Resi Manual
                </a>
            </div>
            <div class="col-6">
                <a href="#" class="LihatResiManual btn btn-info w-100" style="font-size:20pt;">
                    Lihat Resi Manual
                </a>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="#" class="ModalResi btn btn-success"
                                        id_rincian_pesanan="{{ $row->id_rincian_pesanan }}">
                                        Resi
                                    </a>
                            ...
                            <td class="text-center">
                                <div class="d-grid gap-2">
                                    ...
                                    @if($row->status_pembayaran == 0)
                                        ...
                                        <a href="#" class="ModalBelumBayar btn btn-info"
                                            id_rincian_pesanan="{{ $row->id_rincian_pesanan }}">
                                            Validasi
                                        </a>
                                    ...
                                    @elseif($row->status_pembayaran == 1)
                                        ...
                                        <button class="btn text-dark" style="background-color: #FFD600;">
                                            DP
                                        </button>

                                        <a href="#" class="LihatBukti btn btn-secondary"
                                            id_rincian_pesanan="{{ $row->id_rincian_pesanan }}">
                                            Lihat Bukti
                                        </a>

                                        <a href="#" class="ModalDP btn btn-info"
                                            id_rincian_pesanan="{{ $row->id_rincian_pesanan }}">
                                            Validasi
                                        </a>
                                        ...
                                        {{-- SUDAH BAYAR (TIKET.COM) --}}
                                        {{-- ========================================= --}}
                                    @elseif($row->status_pembayaran == 2 && $row->tiket_com == 1)
                            ...
                            <td class="text-center">
                                ...
                                <div class="d-grid gap-2">
                                    ...
                                    <form action="/HapusPesanan/{{ $row->id_rincian_pesanan }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="dibuat_oleh" class="dibuat_oleh">
                                        <button type="submit" class="btn btn-danger w-100 HapusPesanan">
                                            Hapus
                                        </button>
                                    </form>
                                </div>
    ...
    <div class="modal fade" id="modal-buat-resi-manual" tabindex="-1" aria-labelledby="ModalResiManual" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width:900px;">
            <div class="modal-content">
                <div class="modal-header bg-info text-white">
                    <h5 class="modal-title" id="ModalResiManual" style="font-size:20pt;">Buat Resi Manual</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body" id="loadResiManual">
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal Lihat Resi Manual -->
    <div class="modal fade" id="modal-lihat-resi-manual" tabindex="-1" aria-labelledby="ModalLihatResiManual"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width:900px;">
            <div class="modal-content">
                <div class="modal-header bg-info text-white">
                    <h5 class="modal-title" id="ModalLihatResiManual" style="font-size:20pt;">Lihat Resi Manual</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body" id="loadLihatResiManual">
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal Validasi DP -->
    <div class="modal fade" id="modal-dp" tabindex="-1" aria-labelledby="ModalDPLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width:900px;">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #FFD600;">
                    <h5 class="modal-title" id="ModalDPLabel" style="font-size:20pt;">Status Pembayaran - DP</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body" id="loadModalDP">
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal Lihat Bukti -->
    <div class="modal fade" id="modal-lihat-bukti" tabindex="-1" aria-labelledby="ModalLihatBukti" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width:900px;">
            <div class="modal-content">
                <div class="modal-header bg-info text-white">
                    <h5 class="modal-title" id="ModalLihatBukti" style="font-size:20pt;">Lihat Bukti Pembayaran</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body" id="loadLihatBukti">
                </div>
            </div>
        </div>
    </div>
...
@push('myscript')
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // ==========================================
            // SAAT HALAMAN DIBUKA BIARKAN KOSONG SEMUA
            // ==========================================
        ...
        $(document).on('click', '.ModalInfo', function (e) {
            ...
            // simpan id terakhir yang dibuka
            $("#modal-info").attr("id_rincian_pesanan", id);
        ...
        // BAGIAN DARI MODAL BUAT RESI MANUAL
        $(document).on('click', '.BuatResiManual', function (e) {
            e.preventDefault();
        ...
        // BAGIAN DARI MODAL LIHAT RESI MANUAL
        $(document).on('click', '.LihatResiManual', function (e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function (respond) {
                    $("#loadLihatResiManual").html(respond);
                    $("#modal-lihat-resi-manual").modal("show");
                }
            });
        });
        ...
        function initBuatResiManual() {
            ...
            const checkInPicker = flatpickr("#tampil_check_in_buat_resi", {
                dateFormat: "Y-m-d",
                altInput: true,
                altFormat: "d F Y",
                locale: flatpickr.l10ns.id,
            ...
            checkOutPicker.config.onChange.push(function (selectedDates) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        check_in: $('#check_in_buat_resi').val(),
                        check_out: $('#check_out_buat_resi').val()
                    },
        ...
        // BAGIAN DARI MODAL DP
        $(document).on('click', '.ModalDP', function (e) {
            e.preventDefault();
        ...
        // BAGIAN DARI MODAL LIHAT BUKTI
        $(document).on('click', '.LihatBukti', function (e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function (respond) {
                    $("#loadLihatBukti").html(respond);
                    $("#modal-lihat-bukti").modal("show");
                }
            });
        });
        ...
        async function pastikanAlbumAda(namaAlbum) {
            const { albums } = await window.Capacitor.Plugins.Media.getAlbums();
            console.log("Daftar album:", albums);

            let album = albums.find(a => a.name === namaAlbum);

            if (!album) {
                console.log("Album belum ada, membuat baru:", namaAlbum);
                await window.Capacitor.Plugins.Media.createAlbum({ name: namaAlbum });

                // Ambil ulang daftar album setelah dibuat, untuk dapat identifier-nya
                const { albums: albumsBaru } = await window.Capacitor.Plugins.Media.getAlbums();
                album = albumsBaru.find(a => a.name === namaAlbum);
            }

            return album?.identifier;
        }

        async function cetakJPG() {
            ...
            const fileName = "Resi-" + Date.now() + ".jpg";

            if (window.Capacitor && window.Capacitor.isNativePlatform()) {

                try {
                    const albumId = await pastikanAlbumAda("Nirwana Hotel Kalianda");

                    const result = await window.Capacitor.Plugins.Media.savePhoto({
                        path: base64,
                        fileName: fileName,
                        albumIdentifier: albumId
                    });

                    console.log("Hasil savePhoto:", result);

                    Swal.fire({
                        icon: "success",
                        title: "Berhasil",
                        text: "Resi berhasil disimpan ke Galeri."
                    });
                    ...
                    const pesanError =
                        ...
                        "Error tidak diketahui, cek Logcat untuk detail.";
        ...
        function kirimWAResiManual(id) {
            ...
            html2canvas(element, {
                ...
                fetch("/upload-resi-wa-manual/" + id, {
        ...
        $(".HapusPesanan").click(function (e) {
            var form = $(this).closest('form');
            e.preventDefault();
            Swal.fire({
                title: "Apakah Anda Yakin ingin menghapus pesanan?",
                text: "Jika Ya Maka Pesanan Customer ini akan terhapus permanen",
                icon: "warning",
                showCancelButton: true,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
