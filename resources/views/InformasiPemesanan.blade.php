    ...
    <script>
        ...
        async function cetakJPG() {
            ...
            if (window.Capacitor && window.Capacitor.isNativePlatform()) {
                ...
                // Cek dulu apakah plugin Media terdaftar di Capacitor
                console.log("Capacitor Plugins tersedia:", Object.keys(window.Capacitor.Plugins));
                console.log("Media plugin ada?", !!window.Capacitor.Plugins.Media);

                if (!window.Capacitor.Plugins.Media) {
                    Swal.fire({
                        icon: "error",
                        title: "Plugin Tidak Ditemukan",
                        text: "Plugin Media belum terpasang di aplikasi native. Perlu build ulang APK setelah npx cap sync."
                    });
                    return;
                }
                ...
                try {
                    const result = await window.Capacitor.Plugins.Media.savePhoto({
                        path: base64,
                        fileName: fileName,
                        albumIdentifier: "Nirwana Hotel Kalianda"
                    });
                    ...
                    // Ambil pesan error dari berbagai kemungkinan bentuk objek error
                    const pesanError =
                        err?.message ||
                        err?.errorMessage ||
                        err?.toString?.() ||
