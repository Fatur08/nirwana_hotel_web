    ...
    <script>
        ...
        async function cetakJPG() {
            ...
            try {
                ...
                Swal.fire("1. Fungsi dipanggil");

                const element = document.querySelector("#area-print");

                Swal.fire("2. Element ketemu");

                const canvas = await html2canvas(element);

                Swal.fire("3. html2canvas berhasil");

                const base64 = canvas.toDataURL("image/jpeg");

                Swal.fire("4. Base64 berhasil");

                alert(JSON.stringify(window.Capacitor));

                const { Filesystem, Directory } = Capacitor.Plugins;

                Swal.fire("5. Plugin berhasil");
                ...
                Swal.fire("6. File berhasil disimpan");
