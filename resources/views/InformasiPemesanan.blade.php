...
@push('myscript')
    <script>
        ...
        async function cetakJPG() {
            ...
            // Tes album
            const albums = await Capacitor.Plugins.Media.getAlbums();
            console.log(albums);
            alert(JSON.stringify(albums));

            // Tes path
            console.log("PATH =", "data:image/jpeg;base64," + base64.substring(0, 50));

            if (window.Capacitor && window.Capacitor.isNativePlatform()) {

                try {

                    const result = await Capacitor.Plugins.Media.savePhoto({
                        path: "data:image/jpeg;base64," + base64,
                        fileName: "Resi-" + Date.now()
                    });
