<form action="/TambahModalSTD/store_TambahModalSTD" method="POST" id="frmTambahModalSTD" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="number" value="" id="nomor_ktp_tamu" class="form-control" name="nomor_ktp_tamu" placeholder="Masukkan Nomor KTP Tamu">
              </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row mb-3">
        <div class="col-12">
            <select id="jumlah_kamar_dipesan_std" name="jumlah_kamar_dipesan_std" class="form-control">
            </select>
        </div>
    </div>
    <div class="row">
