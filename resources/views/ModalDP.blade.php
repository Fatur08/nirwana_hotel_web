@extends('layouts.ModalDP')
@section('content')
    <form action="{{ url('ModalDP/store_ModalDP') }}" method="POST" id="frmModalDP" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    <button class="btn w-100" type="submit" style="font-size:16pt; background-color: #FFD600;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
...
@push('myscript')
    <script>
        ...
        $(document).ready(function () {
            ...
            // ==========================
            $(document).on('submit', '#frmModalDP', function (e) {
