...
@section('content')
    ...
    <form action="{{ url('PesanKamar/store_PesanKamar') }}" method="POST" id="frmPesanKamar" enctype="multipart/form-data">
        ...
        <div id="formBooking" style="display:none;">
            ...
            <div class="row" id="tiket_dot_com_container" style="display:none;">
                <div class="col-12">
                    <h5 class="text-start" style="font-size:16pt;">
                        Apakah Pesanan dari Tiket.com?
                    </h5>
            ...
            <div class="row mb-6" id="tiket_dot_com_input" style="display:none;">
                <div class="col-12">
                    <select id="tiket_dot_com" name="tiket_dot_com" class="form-control" style="font-size:16pt;">
...
@push('myscript')
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#tiket_dot_com_container').hide();
            $('#tiket_dot_com_input').hide();
            ...
            $('#customer_baru').change(function () {
                ...
                // ==========================
                // RESET PEMBAYARAN (status, metode, tiket.com, sumber, bukti)
                // ==========================
                $('#status_pembayaran').val('').trigger('change');
            ...
            $(document).on('change', '#status_pembayaran', function () {
                ...
                $('#tiket_dot_com_container, #tiket_dot_com_input').hide();
            ...
            $(document).on('change', '#metode_pembayaran', function () {
                ...
                $('#sumber_pembayaran_container, #sumber_pembayaran_input').hide();
                $('#bukti_pembayaran_container, #bukti_pembayaran_input').hide();
                $('#ticket_dot_com_container, #ticket_dot_com_input').hide();
                ...
                if (status === '2') {
                    ...
                    if (metode === 'online') {
                        ...
                        $('#ticket_dot_com_container').show();
                        $('#ticket_dot_com_input').show();

                        // Bukti Pembayaran selalu muncul, terlepas dari jawaban Ticket.com
                        $('#bukti_pembayaran_container').show();
                        $('#bukti_pembayaran_input').show();

                        // Sumber Pembayaran TIDAK langsung dimunculkan di sini
                        // Ditentukan oleh jawaban Ticket.com (lihat handler #ticket_dot_com di bawah)
            ...
            // TIKET.COM
            // ==========================
            $(document).on('change', '#tiket_dot_com', function () {
