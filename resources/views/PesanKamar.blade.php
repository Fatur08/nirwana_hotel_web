    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '#metode_pembayaran', function () {
                ...
                if (status === '2') {
                    ...
                    if (metode === 'online') {
                        ...
                        $('#tiket_dot_com_container').show();
                        $('#tiket_dot_com_input').show();

                        // Sumber & Bukti Pembayaran TIDAK langsung dimunculkan di sini
                        // Ditentukan oleh jawaban tiket.com (lihat handler #tiket_dot_com di bawah)
            ...
            $(document).on('change', '#tiket_dot_com', function () {
                ...
                // Jika jawabannya "Tidak" (bukan dari tiket.com)
                if (tiketCom === '0') {
                ...
                // Jika jawabannya "Ya" (dari tiket.com), tetap tersembunyi
