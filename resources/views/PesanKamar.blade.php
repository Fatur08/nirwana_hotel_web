    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '#metode_pembayaran', function () {
                ...
                if (status === '2') {
                    ...
                    if (metode === 'online') {
                        ...
                        // (lihat handler #tiket_dot_com di bawah)
            ...
            $(document).on('submit', '#frmPesanKamar', function (e) {
                ...
                // =========================================
                // VALIDASI PEMBAYARAN ONLINE - DP
                // =========================================
                if (status == '1' && metode == 'online') {
                ...
                // =========================================
                // VALIDASI PEMBAYARAN ONLINE - SUDAH BAYAR
                // =========================================
                if (status == '2' && metode == 'online') {
                    ...
                    // Sumber Pembayaran hanya wajib jika BUKAN dari Tiket.com
