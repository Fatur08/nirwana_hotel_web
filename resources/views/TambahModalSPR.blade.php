<form action="{{ url('TambahModalSPR/store_TambahModalSPR') }}" method="POST" id="frmTambahModalSPR" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="" id="nama_tamu_spr" class="form-control" style="font-size:16pt;" name="nama_tamu_spr" placeholder="Masukkan Nama Tamu">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="check_in_tampil_spr" class="form-control flatpickr" style="font-size:16pt;" placeholder="Masukkan Tanggal Check-In" autocomplete="off">
                <input type="hidden" id="check_in_spr" name="check_in_spr">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="check_out_tampil_spr" class="form-control flatpickr" style="font-size:16pt;" placeholder="Masukkan Tanggal Check-Out" autocomplete="off">
                <input type="hidden" id="check_out_spr" name="check_out_spr">
            </div>
        </div>
    </div>
    ...
    <div class="row" id="kamar_tersedia_title_spr" style="display:none;">
        <div class="col-12">
            <h5 class="text-start" style="font-size:16pt;">Kamar Yang Tersedia</h5>
        </div>
    </div>
    <div class="row mb-3" id="kamar_tersedia_list_spr" style="display:none;">
        <div class="col-12">
    ...
    <div class="row mb-3">
        <div class="col-12">
            <select id="request_spr" name="request_spr" class="request_spr form-control" style="font-size:16pt;">
    ...
    <div class="row" id="biaya_container_spr" style="display: none;">
        <div class="col-12">
            <h5 class="text-start" style="font-size:16pt;">Biaya Tambahan</h5>
        </div>
    </div>
    <div class="row" id="biaya_input_container_spr" style="display: none;">
        <div class="col-12">
            <div class="input-icon mb-3">
                <span class="input-icon-addon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <input type="text" id="biaya_request_spr" class="form-control"
                    style="font-size:16pt;" readonly>
                <input type="hidden" id="biaya_request_value_spr" name="biaya_request_spr">
            </div>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col-12">
            <select id="metode_pembayaran_spr" name="metode_pembayaran_spr" class="form-control" style="font-size:16pt;">
    ...
    <div class="row" id="sumber_pembayaran_container_spr" style="display:none;">
        <div class="col-12">
            <h5 class="text-start" style="font-size:16pt;">Masukkan Sumber Pembayaran Online</h5>
        </div>
    </div>
    <div class="row mb-3" id="sumber_pembayaran_input_spr" style="display:none;">
        <div class="col-12">
            <div class="input-icon mb-3">
                <span class="input-icon-addon">
                    <!-- icon -->
                ...
                <input type="text"
                    id="sumber_pembayaran_spr"
                    name="sumber_pembayaran_spr"
                    class="form-control"
                    style="font-size:16pt;"
